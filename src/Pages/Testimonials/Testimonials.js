...
const API_URL = `${process.env.REACT_APP_SERVICE_PROVIDER_USER_WEBSITE_BASE_API_URL}/api/customer/testimonials`;
  ...
  const renderStars = (rating) => {
    return Array.from({ length: 5 }, (_, index) => (
      <Star
        ...
        size={24}
        fill={index < rating ? "#f88600" : "none"}
        stroke={index < rating ? "#f88600" : "#e0e0e0"}
      />
    ));
  };
        ...
        <div className="container nav-container">
          <div className="testimonial-header">
            ...
            <div className="navigation-buttons">
              <button className="nav-button testimonial-btn" onClick={handlePrevious} aria-label="Previous testimonial">
                <ChevronLeft size={24} />
              </button>
              <button className="nav-button testimonial-btn" onClick={handleNext} aria-label="Next testimonial">
          ...
          <div className="testimonial-content">
            ...
            <div>
              <p className="testimonial-text">
                {isTextLong && !showFullText ? `${words.slice(0, 20).join(" ")}...` : currentTestimonial.comment}
                {isTextLong && (
                  <button className="toggle-text-btn ml-4" onClick={() => setShowFullText((prev) => !prev)}>
