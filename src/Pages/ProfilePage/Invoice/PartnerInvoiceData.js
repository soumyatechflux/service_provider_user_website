...
const styles = StyleSheet.create({
  ...
  smallText: {
    fontSize: 2, // or any size you prefer
  },
  invoiceMeta: {
    width: '50%',
    paddingLeft: 10,
  ...
  {[
    {
      ...
      description: `Service fee - ${data?.category?.category_name || ''}`,
      qty: 1,
...
<View style={styles.totalSection}>
  ...
  {data?.billing_amount && (
    <Text>({numberToWords(data?.partner_to_customer?.total_amount)} Rupees Only)</Text>
  )}
</View>
...
export default PartnerInvoiceData;
