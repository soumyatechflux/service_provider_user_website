...
const UpcomingTab = () => {
  // console.log("1st",selectedReason)
  ...
  const handleConfirmationNext = async () => {
    ...
    try {
      ...
      console.error("Error during cancellation:", error.response?.data || error.message);
        ...
        {bookings.map((booking, index) => (
          <div key={index} className="booking-item">
            ...
            <div className="column1">
              ...
              <button className="btn-cancel" onClick={() => handleCancelClick(booking?.booking_id)}>Cancel</button>
