                ...
                >
                 {directionsResponse && map && (
                  <DirectionsRenderer
                    ...
                    onDirectionsChanged={() => {
                      // Optional: if you want to capture the updated route
                      // you can access it like this
                      const updatedDirections = map.__lastRenderer?.getDirections?.();
                      if (updatedDirections) {
                        const leg = updatedDirections.routes[0].legs[0];
