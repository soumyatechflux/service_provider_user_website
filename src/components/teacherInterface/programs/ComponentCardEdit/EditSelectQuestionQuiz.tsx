    ...
    return (
        ...
        >
            ...
            >
                ...
                {
                    //@ts-expect-error oldData
                    queryClient.getQueryData(['quizEdit', quiz?.id ?? '', course.id])?.[index]?.image ? (
                        //@ts-expect-error oldData
                        <img src={queryClient.getQueryData(['quizEdit', quiz?.id ?? '', course.id])?.[index]?.image} alt='Question' style={{ width: '100px', height: '100px', borderRadius: '9999px' }} />
                    ) : (
